...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2024 a las 21:35:05
...
INSERT INTO `peliculas` (`id`, `titulo`, `episodio`, `descripcion`, `director`, `estreno`, `duracion`, `imagen`) VALUES
...
(7, 'Star Wars: Episode VII - The Force Awakens', 7, 'En \"El Retorno del Jedi\", la Alianza Rebelde se enfrenta al Imperio en la batalla final. Luke Skywalker confronta a Darth Vader y al Emperador Palpatine en la segunda Estrella de la Muerte. Con la redención de Vader y la destrucción del Emperador, la película concluye la trilogía original con la caída del Imperio y la restauración de la paz en la galaxia.\r\n', 'J. J. Abrams', '2015', 138, 'episodio7.webp'),
