...
-- Tiempo de generación: 12-11-2024 a las 06:15:35
...
CREATE TABLE `naves` (
  ...
  `velocidad_maxima` int(5) NOT NULL,
...
(10, 'Naboo N-1 Starfighter', 'El N-1 Starfighter es un caza estelar utilizado por la fuerza de defensa de Naboo. Con su diseño elegante y armamento eficiente, ha demostrado ser eficaz tanto en combates espaciales como en la defensa planetaria. Esta nave fue utilizada notablemente durante la Batalla de Naboo, donde jugó un papel importante en la victoria sobre la Federación de Comercio.\r\n', 'Caza estelar', 'Theed Palace Space Vessel Engineering Corps', 11.00, 1100, 'Cañones láser', 1, 'NabooN1.webp');
...
INSERT INTO `peliculas` (`id`, `titulo`, `episodio`, `era`, `descripcion`, `director`, `estreno`, `duracion`, `imagen`) VALUES
(1, 'Star Wars: Episodio I - La Amenaza Fantasma', 1, 'Caída de los Jedi', 'Ambientada 32 años antes de los eventos de la trilogía original, \"La Amenaza Fantasma\" sigue al Maestro Jedi Qui-Gon Jinn y a su aprendiz Obi-Wan Kenobi mientras protegen a la Reina Amidala y descubren a un joven esclavo llamado Anakin Skywalker, quien muestra un potencial excepcional con la Fuerza. La película explora los primeros conflictos con los Sith y el inicio de las Guerras Clon.\r\n', 'George Lucas', '1999', 136, 'episodio1.webp'),
(2, 'Star Wars: Episodio II - El Ataque de los Clones', 2, 'Caída de los Jedi', 'Diez años después de \"La Amenaza Fantasma\", \"El Ataque de los Clones\" se centra en el creciente conflicto entre la República y el movimiento separatista. Anakin Skywalker, ahora un joven Jedi, se enfrenta a nuevos desafíos emocionales mientras protege a Padmé Amidala, y la galaxia se prepara para una guerra a gran escala. La película introduce el inicio de las Guerras Clon.\r\n', 'George Lucas', '2002', 142, 'episodio2.webp'),
(3, 'Star Wars: Episodio III - La Venganza de los Sith', 3, 'Caída de los Jedi', 'La venganza de los Sith muestra el dramático desenlace de las Guerras Clon, donde Anakin Skywalker sucumbe al lado oscuro, se convierte en Darth Vader, y ayuda a Darth Sidious a destruir la Orden Jedi. La película concluye con la caída de la República y el nacimiento del Imperio Galáctico, así como con el nacimiento de Luke y Leia, hijos de Anakin y Padmé.\r\n', 'George Lucas', '2005', 140, 'episodio3.webp'),
(4, 'Star Wars: Episodio IV - Una Nueva Esperanza', 4, 'Era de la Rebelión', 'Originalmente lanzada como \"Star Wars\" en 1977, \"Una Nueva Esperanza\" sigue a Luke Skywalker, un joven granjero que se une a la Alianza Rebelde para combatir al Imperio Galáctico. Con la ayuda de la Princesa Leia, Han Solo, y Obi-Wan Kenobi, Luke destruye la primera Estrella de la Muerte, marcando una gran victoria para la Rebelión.\r\n', 'George Lucas', '1977', 121, 'episodio4.webp'),
(5, 'Star Wars: Episodio V - El Imperio Contraataca', 5, 'Era de la Rebelión', 'Considerada una de las mejores películas de la saga, \"El Imperio Contraataca\" muestra a los rebeldes huyendo del Imperio después de la Batalla de Hoth. Luke Skywalker recibe entrenamiento de Yoda, pero se enfrenta a una amarga derrota en su enfrentamiento con Darth Vader, quien revela su verdadera identidad. La película deja a la galaxia en un punto bajo, con los héroes dispersos y en peligro.\r\n', 'Irvin Kershner', '1980', 124, 'episodio5.webp'),
(6, 'Star Wars: Episodio VI - El Retorno del Jedi', 6, 'Era de la Rebelión', 'En \"El Retorno del Jedi\", la Alianza Rebelde se enfrenta al Imperio en la batalla final. Luke Skywalker confronta a Darth Vader y al Emperador Palpatine en la segunda Estrella de la Muerte. Con la redención de Vader y la destrucción del Emperador, la película concluye la trilogía original con la caída del Imperio y la restauración de la paz en la galaxia.\r\n', 'Richard Marquand', '1983', 131, 'episodio6.webp'),
(7, 'Star Wars: Episodio VII - El Despertar de la Fuerza', 7, 'Ascenso de la Primera Orden', 'En \"El Retorno del Jedi\", la Alianza Rebelde se enfrenta al Imperio en la batalla final. Luke Skywalker confronta a Darth Vader y al Emperador Palpatine en la segunda Estrella de la Muerte. Con la redención de Vader y la destrucción del Emperador, la película concluye la trilogía original con la caída del Imperio y la restauración de la paz en la galaxia.\r\n', 'J. J. Abrams', '2015', 138, 'episodio7.webp'),
(8, 'Star Wars: Episodio VIII - Los Últimos Jedi', 8, 'Ascenso de la Primera Orden', 'En \"Los Últimos Jedi\", Rey busca entrenamiento de Luke Skywalker, quien se ha exiliado a sí mismo tras la caída de su intento de reconstruir la Orden Jedi. Mientras tanto, la Resistencia lucha por sobrevivir contra la Primera Orden. La película explora temas de legado, redención, y el conflicto entre la luz y la oscuridad dentro de Rey y Kylo Ren.\r\n', 'Rian Johnson', '2017', 152, 'episodio8.webp'),
(9, 'Star Wars: Episodio IX - El Ascenso de Skywalker', 9, 'Ascenso de la Primera Orden', 'La conclusión de la saga Skywalker, \"El Ascenso de Skywalker\" sigue a Rey, Finn y Poe mientras se enfrentan a la amenaza final del Emperador Palpatine, quien ha regresado de las sombras para liderar la Primera Orden. Rey descubre la verdad sobre su linaje y enfrenta su destino en una batalla épica por el futuro de la galaxia.\r\n', 'J. J. Abrams', '2019', 142, 'episodio9.webp'),
(10, 'Rogue One: Una Historia de Star Wars', NULL, 'Reinado del Imperio', '\"Rogue One\" narra la historia del grupo de rebeldes que roba los planos de la primera Estrella de la Muerte, evento que se menciona en \"Una Nueva Esperanza\". Liderados por Jyn Erso, los rebeldes arriesgan sus vidas en una misión suicida para asegurar la victoria de la Alianza Rebelde. La película destaca por su tono más oscuro y su enfoque en los sacrificios hechos por aquellos que luchan contra el Imperio.\r\n', 'Gareth Edwards', '2016', 133, 'rogue-one.webp');
