<?php require "partials/header.php" ?>
    ...
    <main>
        <section id="presentacion" class="container-fluid mt-5">
            <div class="row">
                <div class="col-3 mb-5 d-flex flex-column justify-content-between">
                    <img width="120px" class="m-4" src="bosquejos/ImagenesSW-propias/Home/deathstar-home.png" alt="Estrella de la Muerte">
                    <img width="150px" class="m-5 align-self-end" src="bosquejos/ImagenesSW-propias/Home/xwing-home.png" alt="X-Wing">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6 d-flex flex-column justify-content-center align-items-center">
                    <div class="row mx-5 p-3">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officia delectus deserunt accusamus quis quisquam alias, hic placeat esse nulla, reiciendis corrupti quam vero. Accusamus non officiis doloremque, ut eos laudantium.</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro et unde delectus reiciendis deleniti aspernatur, aliquam omnis. Voluptatum, dolor, aut doloribus perferendis quaerat ipsa repellendus fuga id cupiditate, earum qui!</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="trailers" class="container-fluid my-5">
            <div class="row d-flex justify-content-center align-items-center py-4">
                <iframe width="940" height="529" src="https://www.youtube.com/embed/-ul1pef501M" title="Star Wars: La venganza de los Sith - TRÁILER MODERNO (2022)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                ...
                <iframe width="940" height="529" src="https://www.youtube.com/embed/EcQKTTwLA-Y" title="Star Wars: El retorno del Jedi - TRÁILER MODERNO | 4K (40 aniversario)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </section>
